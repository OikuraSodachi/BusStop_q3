 ...
 */
public abstract class Hilt_EndFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_EndFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EndFragment_GeneratedInjector) this.generatedComponent()).injectEndFragment(UnsafeCasts.<EndFragment>unsafeCast(this));
    }
  }
