 ...
 */
public abstract class Hilt_StartEndOptionFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_StartEndOptionFragment() {
    super();
  }

  Hilt_StartEndOptionFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((StartEndOptionFragment_GeneratedInjector) this.generatedComponent()).injectStartEndOptionFragment(UnsafeCasts.<StartEndOptionFragment>unsafeCast(this));
    }
  }
