...
public class FragmentStartBindingImpl extends FragmentStartBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.startRecyclerView, 1);
    }
    // views
    @NonNull
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.StartFragment == variableId) {
            setStartFragment((com.todokanai.busstop.fragment.startend.StartFragment) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setStartFragment(@Nullable com.todokanai.busstop.fragment.startend.StartFragment StartFragment) {
