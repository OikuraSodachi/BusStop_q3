 ...
 */
public abstract class Hilt_BusArriveFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_BusArriveFragment() {
    super();
  }

  Hilt_BusArriveFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BusArriveFragment_GeneratedInjector) this.generatedComponent()).injectBusArriveFragment(UnsafeCasts.<BusArriveFragment>unsafeCast(this));
    }
  }
